...
class MainOperation:
    ...
    def create_node(self):
        utils.exec_cmd(f"linstor node delete {self.yaml_info_list['node'][0]['username']}")
        utils.exec_cmd(f"linstor node delete {self.yaml_info_list['node'][1]['username']}")
        utils.exec_cmd(f"linstor node delete {self.yaml_info_list['node'][2]['username']}")